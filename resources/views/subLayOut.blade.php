...
<body>
    <header id="header"><!--header-->
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +0343255073</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> luuhang270198@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="checkout.html"><i class="fa fa-crosshairs"></i> My grammar</a></li>
                                <li><a href="cart.html"><i class="fa fa-star"></i> My Vocabury</a></li>
        ...
        <div class="header-bottom" id=""><!--satrt header-bottom-->
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="{{URL::to('/trang')}}">Vocabulary<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.html">Grammar</a></li>
                                        <li><a href="product-details.html">Listening</a></li> 
                                        <li><a href="checkout.html">Reading</a></li> 
                                        <li><a href="cart.html">More</a></li> 
                                        <li><a href="login.html">Login</a></li> 
                                    </ul>
                                </li> 
                                <li class="dropdown"><a href="#">Grammar<i class="fa fa-angle-down"></i></a>
                                   <!--  <ul role="menu" class="sub-menu">
                                ...
                                <li class="dropdown"><a href="#">Games<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>E</span>nglish For You</h2>
                            <p>We hope you have a good future. </p>
                        </div>
                    </div>
                    <div class="col-sm-7">
